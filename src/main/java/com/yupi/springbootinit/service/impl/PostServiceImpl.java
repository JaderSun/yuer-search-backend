                ...
                postIdList.forEach(postId -> {
                    if (idPostMap.containsKey(postId)) {
                        ...
                        if (searchText == null || searchText.trim().equals("")) {
                            ...
                            if (postEsDTOSearchHit.getHighlightField("title").size() == 0);
                            post.setTitle(postEsDTOSearchHit.getHighlightField("title").size() == 0 ? post.getTitle() : postEsDTOSearchHit.getHighlightField("title").get(0));
                            post.setContent(postEsDTOSearchHit.getHighlightField("content").size() == 0 ? post.getContent() : postEsDTOSearchHit.getHighlightField("content").get(0));
